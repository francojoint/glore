...
/**
 * @param {string[]} names
 * @param {boolean} relativeParents
 */
export const noRestrictedImports = (names = [], relativeParents = true) => ({
  paths: [...NAMED_IMPORTS, ...names].map(name => ({
    name,
    importNames: ['default'],
...
/**
 * @param {Record<string, string[]>} customGroups
 */
export const sortImports = (customGroups = {}) => ({
  internalPattern: ['@/**'],
  ...
  customGroups: {
    value: { ...CUSTOM_GROUPS, ...customGroups },
    type: { ...CUSTOM_GROUPS, ...customGroups },
  },
})
