import type { IsFunction, IsOptional, IsValueType } from './common'
...
export type Dto<T> =
  IsFunction<T> extends true ? never : IsOptional<T> extends true ? Dtoified<Exclude<T, undefined>> | null : Dtoified<T>
